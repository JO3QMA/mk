...
func newQueryHandler(t *testing.T) (*Handler, *testutil.MockNoteRepository) {
	...
	h := NewHandler(noteRepo, createSvc, deleteSvc, querySvc, nil, nil, idGen)
	return h, noteRepo
}
...
func newFailingQueryHandler(t *testing.T) *Handler {
	...
	return NewHandler(repo, createSvc, deleteSvc, querySvc, nil, nil, idGen)
}
...
func TestShow_FallbackNoQueryService(t *testing.T) {
	...
	h := NewHandler(noteRepo, createSvc, deleteSvc, nil, nil, nil, idGen)
