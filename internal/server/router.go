...
func (s *Server) setupRoutes() {
	...
	api.POST("/admin/roles/show", adminHandler.RolesShow, middleware.RequireModerator(roleService))
	api.POST("/admin/roles/list", adminHandler.RolesList, middleware.RequireModerator(roleService))
	...
	api.POST("/admin/announcements/create", announcementHandler.AdminCreate, middleware.RequireModerator(roleService))
	api.POST("/admin/announcements/update", announcementHandler.AdminUpdate, middleware.RequireModerator(roleService))
	api.POST("/admin/announcements/delete", announcementHandler.AdminDelete, middleware.RequireModerator(roleService))
	api.POST("/admin/announcements/list", announcementHandler.AdminList, middleware.RequireModerator(roleService))
	...
	api.POST("/admin/server-info", adminHandler.ServerInfo, middleware.RequireModerator(roleService))
