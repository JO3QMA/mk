...
> 混じりうるので、乖離を判断するときは対象の実装を現 pin (`2026.9.0-mk.22c`) で確認すること。
...
| config キー | 20 前後 | 0 | — |
| fork frontend の独自変更 | 88 tag (`2026.7.0-mk.0` ～ `2026.9.0-mk.22c`) | — | — |
...
**現在の pin は `2026.9.0-mk.22c` (`f6179c85`)。** tag 列は「その変更が最初に入った世代」で、
